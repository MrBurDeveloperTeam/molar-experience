/**
 * Ported from Content Studio's `src/VirtualPet/components/DragLayer.tsx`.
 * Only change: soap/shower icon URLs now resolve to bundled package assets
 * instead of host-relative `/images/...` paths.
 */
